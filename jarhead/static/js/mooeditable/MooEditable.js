...
this.MooEditable = new Class({
	...
	options: {
		...
		xhtml : true,
		semantics : true,
		actions: 'formatBlock bold italic underline strikethrough insertunorderedlist insertorderedlist indent outdent | undo redo | createlink unlink | image | toggleview forecolor',
		handleSubmit: true,
		handleLabel: true,
		disabled: false,
