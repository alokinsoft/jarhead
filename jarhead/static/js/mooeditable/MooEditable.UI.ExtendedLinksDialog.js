        ...
        onClick: function(e){
            ...
            if (button.hasClass('dialog-cancel-button')){
                ...
                if(protocol_input.get('value') == 'mailto'){
                    ...
                    if (url_input.get('value').indexOf('http://') === 0 || url_input.get('value').indexOf('https://') === 0) {
                        editor.selection.insertContent('<a href="' + url_input.get('value') + '" target="' + target_input.get('value') + '">' + editor.selection.getText() + '</a>');
                    } else {
